...
function SurahList() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 mb-4">Error loading Surahs: {error.message}</p>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Explore all 114 chapters of the Holy Quran. Each Surah contains divine guidance and wisdom.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {surahs.map((surah) => (
            ...
            >
              <Link to="/surah/$id" params={{ id: surah.id.toString() }} className="block">
